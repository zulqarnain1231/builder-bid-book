  ...
  return (
    ...
    >
      <div className={`sm:w-[600px] ${style}`}>
        <div className="w-full bg-brand-tartary h-[60px] flex sm:gap-0 gap-4 justify-between items-center p-4 sm:p-6">
        ...
        <div className="p-4 sm:p-6 max-h-[500px] overflow-auto">{children}</div>
      </div>
    </Dialog>
  );
}
